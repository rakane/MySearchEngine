...
bool Search::Synonyms::find(std::string word, Search::SynonymList& synonyms) const
{
    bool found(false);
...
void Search::Synonyms::processSynonym(const std::string& row) const
{
...
std::size_t Search::Synonyms::numSynonyms() const
{
